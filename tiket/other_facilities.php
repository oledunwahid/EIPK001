                    ...
                    <div class="d-flex justify-content-between">
                        <div>
                            <?php if (isset($row7['admin']) && ($row7['admin'] == '1' || ($row7['ga3'] == '1'))) {
                                ...
                                $sql = mysqli_query($koneksi, "SELECT id_ga_other_facilities FROM ga_other_facilities WHERE nik_request='$niklogin' ");
                                $totalTicket = mysqli_num_rows($sql);
                            }
                            ?>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <?php
                            if (isset($row7['admin']) && ($row7['admin'] == '1' || ($row7['ga3'] == '1'))) {
                                $sql1 = mysqli_query($koneksi, "SELECT id_ga_other_facilities FROM ga_other_facilities WHERE status = 'On Process'");
                                $ProcessTicket = mysqli_num_rows($sql1);
                            } else {
                                $sql1 = mysqli_query($koneksi, "SELECT id_ga_other_facilities FROM ga_other_facilities WHERE status = 'On Process' AND (nik_request = '$niklogin' OR id_ga_other_facilities = '$niklogin')");
                                $ProcessTicket = mysqli_num_rows($sql1);
                            }
                            ?>
                                    ...
                                    <table id="datalengkap" class="stripe row-border order-column" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST["filter"])) {
                                                ...
                                                ?>
                                                        <tr>
                                                            <td><a href="index.php?page=Edit Other Facilities&id=<?= $row6['id_ga_other_facilities']; ?>"><?= $row6['id_ga_other_facilities'] ?></a></td>
                                                            ...
                                                            <td>
                                                                <div class="dropdown d-inline-block">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                        <li>
                                                                            <a href="index.php?page=Edit Other Facilities&id=<?= $row6['id_ga_other_facilities']; ?>" class="dropdown-item"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </td>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td><a href="index.php?page=View Other Facilities&id=<?= $row6['id_ga_other_facilities']; ?>"><?= $row6['id_ga_other_facilities'] ?></a></td>
                                                            <td><?= $row6['start_date'] ?></td>
                                                            <td><?= $row6['end_date'] ?></td>
                                                            <td><?= $row6['nama_request'] ?></td>
                                                            <td><?= $row6['description'] ?></td>
                                                            ...
                                                            <td>
                                                                <div class="dropdown d-inline-block">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                        <li>
                                                                            <a href="index.php?page=View Other Facilities&id=<?= $row6['id_ga_other_facilities']; ?>" class="dropdown-item"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 1070px;">
        <div class="modal-content border-0">
            <div class="modal-header p-3 bg-soft-info">
                <h5 class="modal-title" id="exampleModalLabel">Create Request GA Facilities - Other Facilities Request (Purchase Request)
                    Support</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
            </div>
            <form action="function/insert_ga_other_facilities.php" method="POST" id="myForm" enctype="multipart/form-data">
                <?php
                $sql = mysqli_query($koneksi, "SELECT * FROM ga_other_facilities");
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" value="<?= $row['status'] ?>" name="statusOther" hidden />
                            <input type="text" class="form-control" value="<?= $row['category'] ?>" name="category" hidden />
                            <input type="text" class="form-control" value="<?= $row['justification'] ?>" name="justification" hidden />
                            <input type="text" class="form-control" value="<?= $row['action_note'] ?>" name="action_note" hidden />
                            <div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary waves-effect waves-light" name="add-ga-other-facilities">Create</button>
                </div>
            </form>
        </div>
    </div>
